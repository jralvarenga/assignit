export default {
  ...
  "Delete all subjects": "Borrar todos los temas",
  "Sign out": "Cerrar sesión",
  "Color scheme": "Actual: {{color}} theme",
  "Test notification": "Test notificación",
  "Reminder every week": "Recordarme cada semana",
  "You're about to delete all your Subjects, are you sure?": "Estás a punto de borrar todos tus temas, ¿Seguro?",

  // Account screen
  "Your account doesn't support sync with Google Calendar": "Tú cuenta no tiene disponible Google Calendar",
  "Account provider": "Proveedor de cuenta",
  "Google Calendar sync": "Sinc. de Google Calendar",
  ...
  "Wait!!": "Alto!!",
  "Are you sure you want to go back?, nothing has been saved yet": "¿Estás seguro que quieres regresar?, no se ha guardado nada",
  "Go back": "Regresar",

  // New subject screen
  "Subject name": "Nombre del tema *",
  "Input your subject info": "Ingresa la info. de tu tema",
  "Subject link": "Link del tema",
  "Reunion link": "Link de reunión",
  "Choose a color": "Escoje un color",
  ...
  // Subject screen
  "You don't have anything pending": "No tienes nada pendiente",
  "Go to link": "Ir a {{subject}} link",
  ...
  "Repeat task every time": "Repite tarea cada {{repeat}}",
  "You've done all your tasks": "Has terminado todas tus tareas💫",
  "Start adding tasks to your list": "Empieza a añadir tareas a tu lista",
  "Repeat": "Repetir",
